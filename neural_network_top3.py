"""Neural Network Code for the top 3 diagnoses"""
...
# vectorize - bagofwords from previous analysis in report
...
sns.lineplot(x=epochs_list, y=train_loss_list, label = 'Training Loss', marker = 'o', color = 'cadetblue' )
plt.xlabel('Epoch', fontsize=14)
plt.ylabel('Avg. Loss', fontsize=14)
plt.title(f"Training Loss Over {epochs} Epochs For Top Three Diagnoses ", fontsize=16)
plt.xticks(epochs_list)
plt.legend(fontsize=10)
plt.grid(True, linestyle='-', alpha=0.7)

# save plot
plt.savefig('RNN_training_loss_plot_top3.png')
